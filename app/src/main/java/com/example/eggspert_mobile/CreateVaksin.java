...
public class CreateVaksin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_vaksin);
        ...
        add.setOnClickListener(view -> {
            ...
            createData(jenisVaksin, tanggalVaksin, idKandang);
            finish();
        });

    }

    public void createData(String jenis_vaksin, String tanggal_vaksin, String id_kandang) {
        SharedPreferences sharedPreferences = getSharedPreferences("EggspertPrefs", MODE_PRIVATE);
        ...
        String url = "http://10.0.2.2:8000/api/vaksinasiku";
