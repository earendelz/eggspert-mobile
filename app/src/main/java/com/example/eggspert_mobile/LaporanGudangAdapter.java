...
public class LaporanGudangAdapter extends RecyclerView.Adapter<LaporanGudangAdapter.ViewHolder> {

    private ArrayList IDList, jenisList, tanggalList, jumlahList, IDGudangList;
    private Context context; private Intent i;

    public LaporanGudangAdapter(Context context, ArrayList IDList, ArrayList jenisList, ArrayList tanggalList,  ArrayList jumlahList, ArrayList IDGudangList) {
        this.context = context;
        this.IDList = IDList;
        this.jenisList = jenisList;
        this.tanggalList = tanggalList;
        this.jumlahList = jumlahList;
        this.IDGudangList = IDGudangList;
    }

    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View listItemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_laporan_gudang, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final String id_gudang = IDGudangList.get(position).toString();
        ...
        holder.option.setOnClickListener(view -> {
            ...
            bsdOption.findViewById(R.id.edit_opt).setOnClickListener(view1 -> {
                i = new Intent(context, EditLaporanGudang.class);
                i.putExtra("id", id);
                i.putExtra("id_gudang", id_gudang);
    ...
    public void deleteData(String idLaporan, String idGudang) {
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                response -> {
                    ...
                    ((KelolaLaporanAyam)context).showData(idGudang);
