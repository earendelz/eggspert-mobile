...
public class DataAdapterLaporan extends RecyclerView.Adapter<DataAdapterLaporan.ViewHolder> {
    private ArrayList IDList, namaList, jenisList, jmlList;
    private Context context;
    private Intent i;

    public DataAdapterLaporan(Context context, ArrayList IDList, ArrayList namaList, ArrayList jenisList, ArrayList jmlList) {
