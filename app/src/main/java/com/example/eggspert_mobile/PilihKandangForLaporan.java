...
public class PilihKandangForLaporan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_kandang_for_laporan);
    ...
    protected void onResume() {
        ...
        adapter = new DataAdapterLaporan(this, IDLIst, namaList, jenisList, jmlList);
    ...
    public void showData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                error -> {
                    ...
                    Toast.makeText(PilihKandangForLaporan.this, "Gagal Mengambil Data Kandang", Toast.LENGTH_SHORT).show();
                }) {
