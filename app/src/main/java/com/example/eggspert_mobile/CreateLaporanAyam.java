...
public class CreateLaporanAyam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_laporan_ayam);
    ...
    public void createData(String jenis_laporan, int jmlAyam, String tanggal_prst, String id_kandang) {
        SharedPreferences sharedPreferences = getSharedPreferences("EggspertPrefs", MODE_PRIVATE);
        String token = sharedPreferences.getString("token", null);
        ...
        String url = "http://10.0.2.2:8000/api/laporanayamku";
        ...
        try {
            ...
            jsonBody.put("tanggal_peristiwa", tanggal_prst);
