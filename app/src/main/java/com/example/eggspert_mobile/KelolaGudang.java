...
public class KelolaGudang extends AppCompatActivity {
    ...
    String namaUser, user_id; Intent i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelola_gudang);
        ...
        add.setOnClickListener(view -> startActivity(new Intent(KelolaGudang.this, CreateGudang.class)));
    ...
    protected void onResume() {
        ...
        if (user_id != null) {
            ...
            adapter = new GudangAdapter(this, IDLIst, namaList, jenisList, jmlList);
    ...
    public void showData() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                error -> {
                    Log.e("API Error", "Error Response: " +  error.getMessage());
                    Toast.makeText(KelolaGudang.this, "Gagal Mengambil Data Gudang", Toast.LENGTH_SHORT).show();
                }) {
