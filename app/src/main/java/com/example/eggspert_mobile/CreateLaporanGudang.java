...
public class CreateLaporanGudang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_laporan_gudang);
        ...
        add.setOnClickListener(view -> {
            ...
            createData(keterangan, tanggal, jmlTelur, idGudang);
            finish();
    ...
    private void createData(String keterangan, String tanggal, int jmlTelur, String idGudang) {
        SharedPreferences sharedPreferences = getSharedPreferences("EggspertPrefs", MODE_PRIVATE);
        String token = sharedPreferences.getString("token", null);
        ...
        String url = "http://10.0.2.2:8000/api/laporangudangku";
        ...
        try {
            ...
            jsonBody.put("tanggal_laporan_gudang", tanggal);
