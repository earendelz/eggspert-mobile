...
public class KelolaLaporanAyam extends AppCompatActivity {
    ...
    ArrayList IDLIst, jenisList, tanggalList, jumlahList, IDKandangList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelola_laporan_ayam);
        ...
        addData.setOnClickListener(view -> {
            i = new Intent(this, CreateLaporanAyam.class);
    ...
    protected void onResume() {
        ...
        adapter = new LaporanAyamAdapter(this, IDLIst, jenisList, tanggalList, jumlahList, IDKandangList);
    ...
    public void showData(String idKandang) {
        ...
        String url = "http://10.0.2.2:8000/api/laporanayamku/" + idKandang;
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(
                ...
                response -> {
                    try {
                        ...
                        for(int count = 0; count < response.length(); count++ ) {
                            ...
                            String jenisLaporan = laporanAyamObject.getString("jenis_laporan");
                            String tanggalPeristiwa = laporanAyamObject.getString("tanggal_peristiwa");
                            String jumlahAyam = laporanAyamObject.getString("jumlah_ayam");
                            String id_kandang = laporanAyamObject.getString("id_kandang");

                            IDLIst.add(id);
                            jenisList.add(jenisLaporan);
                            tanggalList.add(tanggalPeristiwa);
                            jumlahList.add(jumlahAyam);
            ...
            Log.e("API Error", "Error Response: " +  error.getMessage());
            Toast.makeText(KelolaLaporanAyam.this, "Gagal Mengambil Data Kandang", Toast.LENGTH_SHORT).show();
